...
export default function Home() {
  return (
    <div className="absolute bottom-[25px] left-[25px] right-[25px] top-[25px] rounded-3xl border-r-2 border-t-2 border-white/40 bg-white/20 shadow-2xl flex flex-col gap-4 justify-center items-center">
