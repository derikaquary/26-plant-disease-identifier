function page() {
  return (
    <div className="flex flex-col gap-6 px-2 py-2">
      <div className="bg-tips1 h-[200px] w-full bg-center bg-cover flex items-end pl-2 rounded-2xl ">
        <div className="w-full h-full flex items-end bg-black/10">
      ...
      <p>
        ...
        factors to ensure they thrive and remain healthy. Here’s a comprehensive
        guide to help you provide the best care for your plants:
      </p>
      <div className="flex flex-col gap-2">
        <h2 className="text-3xl">1. Watering</h2>
        <p>
          Watering is crucial for plant health. However, the amount and
          frequency of watering can vary depending on the type of plant and the
          environment.
        </p>
        <ul className="flex flex-col gap-2">
          ...
          <li>
            Type of Water: Use room temperature water. Some plants are sensitive
            to the chemicals in tap water, so consider using filtered or
      ...
      <div className="flex flex-col gap-2">
        ...
        <ul className="flex flex-col gap-2">
          ...
          <li>
            Low Light: Ideal for areas with limited natural light. These plants
            can thrive with minimal light.
          </li>
        </ul>
      </div>
      <div className="flex flex-col gap-2">
      ...
      <div className="flex flex-col gap-2">
        ...
        <ul className="flex flex-col gap-2">
          <li>
            Pruning: Remove dead or yellowing leaves and spent flowers to direct
      ...
      <div className="flex flex-col gap-2">
        ...
        <ul className="flex flex-col gap-2">
          ...
          <li>
            How to Repot: Choose a pot that’s one size larger. Remove the plant
            from the old pot, gently loosen the roots, and place it in the new
            pot with fresh soil.
          </li>
        </ul>
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <p>
          ...
          living space and provides a sense of accomplishment. By understanding
          and meeting the specific needs of your plants, you can enjoy their
